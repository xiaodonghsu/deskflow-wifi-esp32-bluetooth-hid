...
ESP32-S3 连接 Wi-Fi，模拟为Deskflow的客户端和HID设备。当平板/手机/电脑添加蓝牙 HID 设备时，Deskflow主机添加设备。每个屏幕的键盘/鼠标事件都会被转发到其配对的电脑、平板或手机。
...
ESP32 启动后，在正常 Wi-Fi 工作站连接之外，还会运行一个 SoftAP。默认 SoftAP 为：
