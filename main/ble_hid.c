...
static const uint8_t s_report_map[] = {
    ...
    0x95,0x06, 0x75,0x08, 0x15,0x00, 0x25,0x66,
    0x05,0x07, 0x19,0x00, 0x29,0x66, 0x81,0x00, 0xC0,
...
{
    const uint8_t power_key[6] = {0x66}; /* Keyboard Power */
    const uint8_t released[6] = {0};
    ble_hid_keyboard(target, 0, power_key);
    vTaskDelay(pdMS_TO_TICKS(20));
    ble_hid_keyboard(target, 0, released);
}
